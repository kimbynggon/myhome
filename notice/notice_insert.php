...
$sql = "insert into notice (id, name, title, text, regist_day, hit, file_name, file_type, file_copied) ";
$sql .= "values('$userid', '$username', '$title', '$text', '$regist_day', 0, ";
