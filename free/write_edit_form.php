...
<body>
    ...
    if (isset($_GET["mode"]) && $_GET["mode"] == "update") {
        ...
        //sql 인젝션
        //'or' 1 or '                              =''or 1 or ' 를 사용해 보안접근을 하면 막아준다.
    ...
    <div id="wrap">
        <div id="col2">
            <div id="title"><h3>QnA 게시판 > 글쓰기</h3></div>
            <div class="clear"></div>
            <div id="write_form_title"><img src="./img/write_form_title.gif"></div>
            <div class="clear"></div>
            <form name="board_form" action="dml_board.php" method="post"
                ...
                <div id="write_button">
                    <input type="image" onclick='document.getElementById("del_file").disabled=true' src="./img/ok.png">&nbsp;
